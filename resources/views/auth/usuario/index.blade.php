...
@section('content')
     ...
     <th> Cedula </th>
     <th> Email </th>
     <a class="btn btn-outline-info" href="{{route('users.create')}}"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-square-dotted" viewBox="0 0 16 16">
